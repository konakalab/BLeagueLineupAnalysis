...
with tab3:
    ...
    * **合計プレイ数**: その5人の組み合わせが合計で何回（OFF/DEF合算）起用されたかを示します。回数は通常利用されるポゼッション ** ではなく**，得点，ボール保持の変更で1回です．
    * 1回のプレイで，攻撃側は得点すること，守備側は失点しないことが ** 小さな勝利 **であるとみなし，その勝率をEloレーティングに似た評価式で評価しました．攻守ともにリーグ平均を ** 0 **，標準偏差を** 10**と変換しています．
